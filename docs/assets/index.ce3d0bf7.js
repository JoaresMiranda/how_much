(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))c(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&c(l)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerpolicy&&(o.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?o.credentials="include":r.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function c(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();document.querySelector("#app").innerHTML=`
...
`;const T=.13,y=.15,P=3.9,k=document.querySelector("#priceForm"),d=document.querySelector("#inputPrice"),i=document.querySelector("#haveTax"),f=document.querySelector("#haveTip"),g=document.querySelector("#inputPriceBr"),B=document.querySelector("#exchangeButton"),C=document.querySelector("#resultContainer"),$=document.querySelector(".resultPrices"),q=document.querySelector("#backButton"),m=e=>parseFloat(e)*T,h=e=>parseFloat(e)+parseFloat(m(e)),u=(e,t)=>t?parseFloat(h(e)*y):parseFloat(e)*y,b=(e,t)=>parseFloat(t?h(e)+u(e,t):e+u(e,t)),a=e=>parseFloat(e)*P,L=(e,t,s)=>{let c=e;return t&&s?c=a(b(c,!0)):t?c=a(e+m(c)):s?c=a(e+u(c)):a(c)},p=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),n=new Intl.NumberFormat("en-CA",{style:"currency",currency:"CAD"}),v=()=>{k.classList.toggle("hidden"),C.classList.toggle("hidden")};d.focus();B.addEventListener("click",e=>{const t=parseFloat(d.value.replace(",","."));if(isNaN(t))return alert("Please, insert a price");const s=L(t,i.checked,f.checked),c=i.checked?`
    ...
    <li>\u{1FAE5} final price: CAD ${n.format(b(t,i.checked))}`:"",o=parseFloat(g.value.replace(",",".")),l=o-s,x=((1-s/o)*100).toFixed(2),w=x>0?"\u2705 It's a good opportunity!":"\u26A0\uFE0F Brazil's price is equal or better.",F=o?`
    <hr>
    <li class="text-sm">${w}</li>
    <li>\u{1F4B0} Brazil's price: ${p.format(o)}</li>
    <li>\u{1F19A} Diff between prices: ${p.format(l)}
