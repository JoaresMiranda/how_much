...
`;const P=.13,y=.15,T=3.9,k=document.querySelector("#priceForm"),d=document.querySelector("#inputPrice"),i=document.querySelector("#haveTax"),f=document.querySelector("#haveTip"),g=document.querySelector("#inputPriceBr"),B=document.querySelector("#exchangeButton"),C=document.querySelector("#resultContainer"),$=document.querySelector(".resultPrices"),q=document.querySelector("#backButton"),m=e=>parseFloat(e)*P,h=e=>parseFloat(e)+parseFloat(m(e)),u=(e,t)=>t?parseFloat(h(e)*y):parseFloat(e)*y,b=(e,t)=>parseFloat(t?h(e)+u(e,t):e+u(e,t)),a=e=>parseFloat(e)*T,L=(e,t,s)=>{let o=e;return t&&s?o=a(b(o,!0)):t?o=a(e+m(o)):s?o=a(e+u(o)):a(o)},p=new Intl.NumberFormat("pt-BR",{style:"currency",currency:"BRL"}),n=new Intl.NumberFormat("en-CA",{style:"currency",currency:"CAD"}),v=()=>{k.classList.toggle("hidden"),C.classList.toggle("hidden")};d.focus();B.addEventListener("click",e=>{const t=parseFloat(d.value.replace(",","."));if(isNaN(t))return alert("Please, insert a price");const s=L(t,i.checked,f.checked),o=i.checked?`
    ...
    <li>\u{1FAE5} final price: CAD ${n.format(b(t,i.checked))}`:"",c=parseFloat(g.value.replace(",",".")),l=c-s,x=((1-s/c)*100).toFixed(2),w=x>0?"\u2705 It's a great opportunity!":"\u26A0\uFE0F Brazil's price is equal or better.",F=c?`
    <hr>
    <li class="text-sm">${w}</li>
    <li>\u{1F4B0} Brazil's price: ${p.format(c)}</li>
    <li>\u{1F19A} Difference between prices:<br /> 
      <span class="ml-7">${p.format(l)}</span>
